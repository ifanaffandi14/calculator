...
public class Calculator extends javax.swing.JFrame {
    ...
    public void arithmetic() {
        switch (calculation) {
            ...
            case 1:
                hasil = number + Double.parseDouble(NumberInput.getText());
                NumberInput.setText(Double.toString(hasil));
                break;
    ...
    private void jButton14ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton14ActionPerformed
        int length = NumberInput.getText().length();
        int angka = NumberInput.getText().length() - 1;
        String store;

        if (length > 0) {
            StringBuilder backspace = new StringBuilder(NumberInput.getText());
            backspace.deleteCharAt(angka);
            store = backspace.toString();
            NumberInput.setText(store);
        }
    }//GEN-LAST:event_jButton14ActionPerformed

    private void jButton15ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton15ActionPerformed
        int exit = JOptionPane.showConfirmDialog(null, "Apakah Anda yakin ingin keluar?", "Konfirmasi Keluar", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
